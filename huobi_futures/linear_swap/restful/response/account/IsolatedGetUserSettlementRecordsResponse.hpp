...
namespace huobi_futures
{
    namespace linear_swap
    {
        namespace restful
        {
            ...
            {
                struct IsolatedGetUserSettlementRecordsResponse
                {
                    string status;
                    ...
                    struct Data
                    {
                        struct Settlement
                        {
                            ...
                            JS_OBJ(symbol, contract_code, margin_mode, margin_account, margin_balance_init, margin_balance, settlement_profit_real,
                                   settlement_time, clawback, funding_fee, offset_profitloss, fee, fee_asset, positions);
                        };
